/* 8.29 (Card Shuffling and Dealing) Modify the app of Fig. 8.11 to deal a five-card poker hand.
        Then modify class DeckOfCards of Fig. 8.10 to include methods that determine whether a hand contains
a) a pair
b) two pairs
...
class Program
{
    static void Main(string[] args)
    {
        ...
        myDeckOfCards.GetPokerHand();
        myDeckOfCards.DefiniteHand();
